\documentclass[12pt,twoside]{article} %original one
...
\usepackage{siunitx}
%this package is for tables from jupy
\usepackage{booktabs}
\usepackage{tabularx}
...
%     \textbf{\MakeUppercase{the HADES Experiment}} \\[0.5\baselineskip] }
	{\Large Nuclear Structure Investigations of Light Nuclei \\[0.3\baselineskip] with the R3B Experiment   \\[0.3\baselineskip]
	}
...
% 	eingereicht und durch die Fakultät für Physik am xx.04.2015 angenommen.
	...
	Pr\"ufende der Dissertation:	&	1. Prof. Dr. Laura Fabbietti \\
							        &	2. apl. Prof. Dr. Jan Friedrich \\
	...
	Die Dissertation wurde am 15.12.2025 bei der Technischen Universit\"at M\"unchen
	eingereicht und durch die TUM School of Natural Sciences am 18.02.2026 angenommen.
...
%}
%% Left header (even pages): section title
%\fancyhead[LE]{\nouppercase{\leftmark}}
%
%% Right header (odd pages): subsection title
%\fancyhead[RO]{\nouppercase{\rightmark}}
% \section updates \leftmark (for Even pages)
\renewcommand{\sectionmark}[1]{\markboth{\thesection\quad #1}{}}
% \subsection updates \rightmark (for Odd pages)
...
\input{./../writings/reaction_models}
%\newpage\null\thispagestyle{empty}\newpage
\input{./../writings/experiment}
\input{./../writings/analysis}
%\newpage\null\thispagestyle{empty}\newpage
\input{./../writings/analysis_qfs.tex}
\input{./../writings/califa_odsl_clustering}
\input{./../writings/summary_outlook}
\newpage
\appendix
\fancyhf{}
\fancyhead[L]{\thepage}
\fancyfoot[C]{\thepage}
\input{./../writings/appendix}
...
\newpage\null\thispagestyle{empty}\newpage
\phantomsection
\bibliographystyle{ieeetr} % original one
\bibliography{main}
%\newpage\null\thispagestyle{empty}\newpage
%\listoffigures
\newpage
...
%\newpage\null\thispagestyle{empty}\newpage
%\include{Danksagung}
\input{./../writings/acknowledgement.tex}
\end{document}
