...
\item \textbf{MWPC2 and MWPC3 hit-level data, right side:}\newline
As described in section \ref{sec:geo_corr} the geometric efficiency of the TWIN MUSIC is restricted 
\item \textbf{MWPC2 and MWPC3 data with own "hit-clustering" level, right side:}\newline
