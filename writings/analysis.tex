...
%\begin{enumerate}
%\item First fit x-distribution with double-gaussian function (free parameter, mean value of both gaussian functions equal) and get mean from fit
%\item Fit again within range mean value +- fixed value (21)
%\item Fit function is integrated in the range -100 up to bound val and compared with the number of data entries in this region
%\item Fit function is integrated in the range  bound val up to 100 and compared with the number of data entries in this region
%\item (data_integral_right_x-integral_fit_right_x_bound) -(data_integral_left_x-integral_fit_left_x_bound) explain compensation
%\end{enumerate}
