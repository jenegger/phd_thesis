...
\begin{figure}[htpb]
    ...
    \includegraphics[width=\textwidth,height=10cm,keepaspectratio=true]{Figures/own_11b_level_scheme.png}
    \caption{
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=\textwidth,height=8cm,keepaspectratio=true]{Figures/fiss_model_kuckuk.png}
    \caption{
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=\textwidth,height=10cm,keepaspectratio=true]{Figures/fission_charge_distr_s455.png}
    \caption{
...
\begin{figure}[hb]
    \centering
    \includegraphics[width=0.9\textwidth]{Figures/ff_charge_vs_ff_tot_mass.pdf}
    %\caption{Correlation between the sum of the fission fragment charges and the total fission fragment mass ($\mathrm{FF}_1 + \mathrm{FF}_2$) for the $(p,2pf)$ reaction channel. The data indicate a transition from asymmetric to symmetric fission modes with increasing excitation energy, reconstructed via proton detection in CALIFA. A clear trend toward reduced total fragment mass at higher excitation energies is observed, consistent with enhanced multi-neutron emission.}
