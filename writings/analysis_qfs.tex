...
\begin{figure}[htpb]
	...
	\end{subfigure}
    \caption{Reconstruction of the opening angle $\theta_{p2p}$ as in Eq.~\ref{eq:opang} from the two clusters with highest energy in CALIFA }
    \label{fig:opang}
\end{figure}
...
By inserting this into the  previous equation, one finally obtains for the binding energy $B$:
\begin{equation}
...
\end{figure}
The resulting Doppler-corrected $\gamma$-ray spectrum is presented in Fig.~\ref{fig:gamma_spec_12c_p2p_11b}, which was obtained after applying the following reaction selection criteria:
\begin{itemize}
...
\end{itemize}
In Fig.~\ref{fig:gamma_spec_12c_p2p_11b}, both peaks associated with the de-excitation of the $^{11}\mathrm{B}$ nucleus from the $1/2^-$ and $3/2^-$ excited states are visible. From the fit to the $1/2^-$ peak, an energy resolution of approximately $0.24\,\mathrm{MeV}$ (FWHM) is extracted.
