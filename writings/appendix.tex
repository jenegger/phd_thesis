...
\hline
\end{tabular}
\caption{Measured charge changing cross sections $\sigma_{\text{iso}}$ with statistical and systematic uncertainties for \(^{12}\)C targets of various thicknesses at different beam energies.}
\end{table}
