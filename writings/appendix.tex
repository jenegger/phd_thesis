...
Even though for the different energies the rates seem to be quite close together, there is a systematic uncertainty. To retrieve the uncertainty the mean rate for the different energy settings $\mu_{energy}$ is calculated and the standard deviation $\Delta_{energy}$. Finally a mean value for the standard deviation $\bar{\Delta_{energy}}$ for all energies is calculated.\\
This uncertainty  on $N_2$ has also to be considered in the systematic uncertainty measurement of the cross section in the general form for both empty and target runs:
\begin{equation*}
\sigma = -\frac{1}{N_t}ln\left(\frac{N^T_2}{N^T_1} \,\frac{N^E_1}{N^E_2}\right)\\
\Rightarrow \left|\frac{\partial\sigma}{\partial N^T_2} \cdot \bar{\Delta_{energy}}\right| = \frac{1}{N_t}\cdot bar{\Delta_{energy}} = \left|\frac{\partial\sigma}{\partial N^E_2} \cdot \bar{\Delta_{energy}}\right|
\Rightarrow \Delta_{N_2} = \sqrt{2} 
\end{equation*}
