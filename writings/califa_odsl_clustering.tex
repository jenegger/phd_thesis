...
The resulting dataset was split into training and test subsets, comprising 13{,}000 and 7{,}000 events, respectively. Since the feature space of  12 is relatively small, the available dataset is sufficiently large for robust training. As demonstrated in the Appendix of Ref.~\cite{JENEGGER2026171048}, the loss function exhibits stable convergence, and no indications of overfitting were observed based on the validation metrics.
...
\subsection{Outlook}\label{sec:ml_califa_outlook}
