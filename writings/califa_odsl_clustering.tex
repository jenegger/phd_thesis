...
The threshold parameter was optimized to yield the best performance according to the custom-defined true positive (TP) and well reconstructed (WR) metrics. A comparison between the geometrical R3B clustering and the agglomerative method is presented in Figure~\ref{fig:r3b_agglo_metrics}.
\begin{figure}[!htb]
       \centering
