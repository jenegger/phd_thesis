...
\subsection{Challenges in Relativistic Gamma Spectroscopy}
...
Gamma-ray energies were sampled from a uniform distribution between $0.3\,\mathrm{MeV}$ and $10\,\mathrm{MeV}$. The interaction of the primary gamma rays with the CsI(Tl) scintillation material was modeled using Geant4.\newline
...
This analysis has been thoroughly documented and published in the journal Nuclear Instruments and Methods in Physics Research Section A (NIM-A)~\cite{JENEGGER2026171048}. A detailed description of the applied methodology can be found in the referenced publication.
