...
\end{equation}
where $\vec{b}$ is the impact parameter introduced as displacement of the projectile's and target's center of mass, see Fig.~\ref{fig:impact_par_glauber}.
TODO: what is the formula for the charge changing cross section?
...
\item[Nuclear density distribution]
\end{description}
