...
\end{itemize}
 \begin{figure}[htbp]
     \centering
     \includegraphics[width=0.8\textwidth]{Figures/impact_par_glauber.pdf}
     \caption{Impact par.}
...
\begin{enumerate}
    ...
    \item \textbf{Eikonal Optical Limit (EOL):} The present work focuses on the quantum-mechanical formulation known as the EOL approach. It is based on the time-independent Schrödinger equation, incorporating the eikonal wave approximation and the introduction of a complex optical potential. This results in a compact and analytically tractable expression for the scattering amplitude, making it particularly suitable for high-energy collisions involving extended targets.
\end{enumerate}
