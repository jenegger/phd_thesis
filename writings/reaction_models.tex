...
\begin{align}\label{eq:tot_cs_def}
    \sigma_{\mathrm{R}} &= \sigma_{\mathrm{inel}} + \sigma_{\mathrm{I}} \quad \text{(Total reaction cross section)} \\
    \sigma_{\mathrm{T}} &= \sigma_{\mathrm{el}} + \sigma_{\mathrm{R}} = \sigma_{\mathrm{el}} + \sigma_{\mathrm{inel}} + \sigma_{\mathrm{I}} \quad \text{(Total cross section)}
\end{align}
...
%Tell the story about the optical theorem 
%and give the results for tot. cross section, elastic, and reaction cross section
%maybe also a short intro why and how this is related to the S-matrix
